    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          {
            text: "RUBRIQUE COMPTABLE",
            href: "/Dashboard/comptabilite/rubrique",
          },
        ],
      },
    ],
    ...
    content = (
      <div>
        <a href="/auth">
          <Button
            variant="ghost"
            className="w-full justify-start cursor-pointer hover:bg-[#ff7b7b] bg-[#ff0000] text-white rounded-none hover:text-white"
          >
            Se connecter
          </Button>
        </a>
...
function SidebarContent({ onClickLink }: { onClickLink?: () => void }) {
  ...
  return (
    <div className="w-[100%] flex flex-col items-start justify-center">
      <div className="flex w-[100%] lg:justify-start lg:items-start  h-32 ">
        <Image
          src="/gapro.svg"
          alt="logo"
          width={1000}
                  ...
                  <CollapsibleContent className="pl-8 space-y-1">
                    {menu.subItems.map((subItem, subIndex) => (
                      <Link
                        ...
                        className={`
                          w-full p-2 flex justify-start items-center font-normal text-sm rounded transition-colors
                          ${
                            pathname === subItem.href
                              ? // Style actif: vérifier l'URL du sous-élément
                                "bg-[#2e2e40] text-white"
                              : // Style inactif:
                                "text-gray-300 hover:bg-[#2e2e40] hover:text-white"
                          }
                        `}
                      >
                        {subItem.text}
